  ...
  return (
    <>
      <main className="w-11/12 m-auto">
        ...
        <section>
          <figure className="w-3/5 m-auto my-8">
            <Image
              src="/Freshy Logo.png"
              alt="Freshy Logo"
              width={500}
          ...
          <article className="space-y-8">
            <div>
              <h2 className="text-coal text-xl font-semibold">Overall</h2>
              <p className="text-coal tracking-wide mt-2 text-justify">
            ...
            <div>
              <h2 className="text-coal text-xl font-semibold">Features</h2>
              <p className="text-coal tracking-wide mt-2 text-justify">
            ...
            <div>
              <h2 className="text-coal text-xl font-semibold">Tech use</h2>
              <p className="text-coal tracking-wide mt-2 text-justify">
