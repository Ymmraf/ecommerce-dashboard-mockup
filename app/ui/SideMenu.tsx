    ...
    if (currentOpen == "navigation") {
      return (
        <>
          <section
            className={clsx(
              "fixed z-40 right-0 top-0 h-full border-1 bg-cream border-coal border-px shadow-md p-4 w-4/5 md:w-2/5",
              {
                hidden: !openSidebar,
                block: openSidebar,
              }
      ...
      return (
        <>
          <section
            className={clsx(
              "fixed z-50 right-0 top-[60px] w-4/5 h-full border-1 bg-cream border-coal border-px shadow-md p-4 md:w-2/5",
              {
                hidden: !openSidebar,
                block: openSidebar,
              }
