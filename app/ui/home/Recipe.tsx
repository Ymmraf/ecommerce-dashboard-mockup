      ...
      <section className="w-11/12 m-auto">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-y-4 md:grid-cols-2 md:gap-x-4">
            <div className="p-8 bg-red-100 rounded-2xl flex justify-center sm:gap-x-8">
            ...
            <div className="p-8 bg-blue-200 rounded-2xl flex justify-center sm:gap-x-8">
              <div className="flex justify-center w-[150px] h-[150px]">
                <Image
                  className="opacity-85 rounded-full size-36"
          ...
          <div className="p-8 bg-leaf rounded-2xl">
            ...
            <div className="flex md:justify-center">
                <Link className="w-2/5 block text-center border border-cream text-cream py-2 rounded-xl hover:bg-cream hover:text-leaf" href="/">View all</Link>
            </div>
          </div>
        </div>
      </section>
